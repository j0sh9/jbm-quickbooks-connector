...
$map = array(
	...
	QUICKBOOKS_QUERY_INVENTORYITEM => array( '_quickbooks_query_inventory_items_request', '_quickbooks_query_inventory_items_response' ),
	);

// This is entirely optional, use it to trigger actions when an error is returned by QuickBooks 
$errmap = array(
	//'500' => '_quickbooks_error_catch500',
